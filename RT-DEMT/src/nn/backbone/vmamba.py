...
from src.nn.backbone.mamba2.ssd_minimal import selective_scan_chunk_fn

__all__ = ['VSSM', 'Backbone_VSSM']
...
class Backbone_VSSM(VSSM):
    def __init__(self, out_indices=(0, 1, 2, 3), pretrained=None, norm_layer="ln", freeze_at=-1, freeze_norm = False, **kwargs):
        ...
        if freeze_at >= 0:
            ...
            for i in range(self.num_layers - freeze_at - 1):
